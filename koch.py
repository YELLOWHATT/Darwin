...
parser = argparse.ArgumentParser(description='This is a science program made to search for bacteria, virukses, protozas and fungi.'
...
if not args.bacteria and not args.virus and not args.protozoa and not args.fungi:
