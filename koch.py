...
class virus:
    ...
    def __init__(self, namev, typev, speciesv, common_name_diseasev, groupv):
        ...
        self.groupv = groupv
        cur.execute("SELECT * FROM bob WHERE name=?", (self.namev,))
        exists = cur.fetchone()
...
class fungi:
    ...
    def __init__(self, namef, typef, speciesf):
        ...
        cur.execute("SELECT * FROM bob WHERE name=?", (self.namef,))
        exists = cur.fetchone()
...
class protozoa:
    ...
    def __init__(self, namep, typep, speciesp, common_name_diseasep):
        ...
        cur.execute("SELECT * FROM bob WHERE name=?", (self.namep,))
        exists = cur.fetchone()
        if not exists:
...
class bacteria:
    ...
    def __init__(self, nameb, typeb, speciesb, common_name_diseaseb):
        ...
        cur.execute("SELECT * FROM bob WHERE name=?", (self.nameb,))
        exists = cur.fetchone()
        if not exists:
...
try:
    ...
    print("Qutting with the error code: {}".format(e))